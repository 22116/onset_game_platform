 ...
 */
final class Version20190606135903 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE audio ADD fft LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE name title VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE audio DROP fft, CHANGE title name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
