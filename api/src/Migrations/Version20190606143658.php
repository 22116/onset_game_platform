 ...
 */
final class Version20190606143658 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE audio ADD beats JSON NOT NULL COMMENT \'(DC2Type:json_array)\', CHANGE fft fft JSON NOT NULL COMMENT \'(DC2Type:json_array)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE audio DROP beats, CHANGE fft fft LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\'');
